#lid driven cavity with SIMPLE and PWIM, Re 10, 4x4 mesh
import numpy as np
...
#re 75, 0.075 m/s , N 8, 0.7, 0.025, massImbalance < 1e-6

uLid = 0.075 # lid velocity = 1 cm/s
N = 8 # no of cells in each direction
...
for loop in range(outer):
    ...
    u_new = uHat + u_rel*uPrime
    v_new = vHat + u_rel*vPrime    
