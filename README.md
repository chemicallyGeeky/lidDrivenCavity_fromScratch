...
Derivations and details:

lid4a.py: explicit relaxation, dense matrix: not working

lid4b.py: implicit relaxation, dense matrix
Re 100 tested with 32x32 mesh

lid4c.py: implicit relaxation, sparse matrix, plot with Ghia (1982) for Re 100, 1000.
