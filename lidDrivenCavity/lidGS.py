...
#solved with a Gauss-Siedel Solver
import numpy as np
...
x = L/N #delta_x
y = L/N #delta_y
outer = 100000  # number of maximum outer loops
...
for loop in range(outer):
    ...
    #solve 
    uM, iteration_num_u = gaussS3.gaussSiedel_solver(uEqn, bx, nIter=100, tol=1e-6)
    vM, iteration_num_v = gaussS3.gaussSiedel_solver(uEqn, by, nIter=100, tol=1e-6)
    ...
    pEqn = pEqn*x
    #solve
    pPrime, iteration_num_p = gaussS3.gaussSiedel_solver(pEqn, mIm, nIter=100, tol=1e-6)
