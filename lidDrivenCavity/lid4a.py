...
#Re 50, L 0.05 , N 8, u_rel 0.7, p_rel 0.025, massImbalance < 1e-6
#Re 50, L 0.05 , N 16, u_rel 0.7, p_rel 0.025, massImbalance < 1e-6
...
for loop in range(outer):
    ...
    u_comp = uHat + uPrime
    u_new = u_rel*u_comp + (1 - u_rel)*u
    v_comp = vHat + vPrime    
    v_new = u_rel*v_comp + (1 - u_rel)*v
